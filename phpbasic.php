...
<style type="text/css">
    ...
    <body>
        ...
        print('<div class="row">'."\n");
        for($i=0;$i<3;$i++){
            $s='<div class="col-md-4"><h1>.col-md-4</h1></div>';
            print($s);
        }
        print('</div>'."\n");
        ...
        $cnt=$total/$cNO;//반복숫자
        for($i=0;$i<$cnt;$i++){
            $s='<div class="col-lg-'.$cNO.'"><h1>.col-m1d-'.$cNO.'</h1></div>';
            print($s);
        }
        print('</div>'."\n");
        ...
        function grid1($cNo=1,$addClass='redbox'){
            $other=12-$cNo;
            $s='<div class="row">';
            $s.='<div class="col-lg-'.$cNo.' "><h3>.col-md-'.$cNo.'</h3></div>'."\n";
            $s.='<div class="col-lg-'.$other.' '.$addClass.'"><h3>.col-md-'.$other.'</h3></div>'."\n";
            $s.='</div>';
            print($s);
        }
        for ($i=11;$i>0;$i--){
